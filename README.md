...
- **Sparks** are the last hour's stories at their coordinates (as are the header totals).
...
worker/        tick.ts: the hour's GDELT batches in, three files out; tests against a real fixture batch
